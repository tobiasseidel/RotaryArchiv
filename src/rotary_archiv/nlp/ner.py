...
class NERProcessor:
    ...
    def __init__(self, model_name: str = "de_core_news_sm"):
        ...
        try:
            ...
            try:
                ...
                print(f"Warnung: spaCy Modell '{model_name}' nicht gefunden. Bitte installieren: python -m spacy download {model_name}")
                self.nlp = None
    ...
    def suggest_entity_type(self, text: str) -> Optional[EntityType]:
        """
